...
```bash
cd deploy/scripts
bash build-all-and-push.sh 4.5.47
```
...
deploy/offline/qq-farm-bot-v4.5.47-offline-amd64.tar.gz
deploy/offline/qq-farm-bot-v4.5.47-offline-arm64.tar.gz
```

上传到服务器后执行：

```bash
tar xzf qq-farm-bot-v4.5.47-offline-amd64.tar.gz
...
- `amd64` 服务器用 `qq-farm-bot-images-amd64.tar.gz` / `qq-farm-bot-v4.5.47-offline-amd64.tar.gz`。
- `arm64` 服务器用 `qq-farm-bot-images-arm64.tar.gz` / `qq-farm-bot-v4.5.47-offline-arm64.tar.gz`。
