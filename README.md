...
![版本](https://img.shields.io/badge/版本-v4.5.52-blue)
...
```bash
APP_IMAGE=smdk000/qq-farm-bot-ui:4.5.52
...
# 如需切到指定版本
bash update-app.sh --image smdk000/qq-farm-bot-ui:4.5.52
...
- `qq-farm-bot-v4.5.52-offline-amd64.tar.gz`
- `qq-farm-bot-v4.5.52-offline-arm64.tar.gz`
...
./scripts/docker/docker-build-multiarch.sh --version 4.5.52
```
...
docker buildx build \
  ...
  -t smdk000/qq-farm-bot-ui:4.5.52 \
...
docker buildx build \
  --platform linux/amd64,linux/arm64 \
  -t ghcr.io/smdk000/qq-farm-ui-pro-max:4.5.52 \
...
./scripts/release/build-release-assets.sh --version v4.5.52
...
```bash
# 查看镜像信息
docker buildx imagetools inspect smdk000/qq-farm-bot-ui:4.5.52
